...
#opter.random_search(n_units=1000, airspeed=20.0, goal_type="thrust_to_weight_ratio", goal_val=0.3, airframe_weight=1.0)
...
prop = pyprop.DatabaseFitProp(name="apc_12x3")
